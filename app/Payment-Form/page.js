                    ...
                    {showOccupationField && (
                      ...
                      >
                        ...
                        <Controller
                          ...
                          control={control}
                          rules={{
                            validate: (value) => !!value || "Choose a bundle.",
                          }}
                          render={({ field }) => (
                            <Select
                              {...field}
                              options={[
                                { value: 9.99, label: "Monthly $9.99" },
                                { value: 19.99, label: "Quarterly $19.99" },
                                { value: 29.99, label: "Biannually $29.99" },
                                { value: 59.99, label: "Annually $59.99" },
                              ]}
                              placeholder="Select"
                              value={
                                field.value
